...
namespace SteamKit2
{
    ...
    public sealed partial class SteamUser : ClientMsgHandler
    {
        ...
        public sealed class LogOnDetails
        {
            ...
            /// savem macine name
            /// </summary>
            public bool SaveMachineName { get; set; }

            /// <summary>
            /// Use this name like machine name 
            /// </summary>
            public string UseMachineName { get; set; }
        }
        ...
        public void LogOn(LogOnDetails details)
        {
            ...
            if (string.IsNullOrEmpty(details.UseMachineName))
            {
                logon.Body.machine_id =
                    HardwareUtils.GetMachineID(details.Username);
            }
            else
            {
                logon.Body.machine_id =
                    HardwareUtils.GetMachineID(details.UseMachineName);
            }
            if (details.SaveMachineName)
            {
                logon.Body.machine_name = details.Username + "_PC";
                logon.Body.machine_name_userchosen = details.Username + "_PC";
